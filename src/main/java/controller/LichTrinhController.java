...
public class LichTrinhController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        cb_GaDen.setOnAction(e -> {
            if (cb_GaDen.getSelectionModel().getSelectedItem() != null && cb_GaDi.getSelectionModel().getSelectedItem() != null) {
        ...
        cb_infoGaDen.setOnAction(e -> {
            if (cb_infoGaDen.getSelectionModel().getSelectedItem() != null && cb_infoGaDi.getSelectionModel().getSelectedItem() != null) {
                if (cb_infoGaDi.getValue().equals(cb_infoGaDen.getValue())) {
                    Alert alert = new Alert(Alert.AlertType.ERROR);
                    alert.setTitle("Lỗi");
                    alert.setHeaderText(null);
                    alert.setContentText("Ga đến và ga đi không được trùng nhau");
                    ...
                    cb_infoGaDen.requestFocus();
                }
            }
        });

        datePicker_tgKhoiHanh.setDayCellFactory(picker -> new DateCell() {
            @Override
        ...
        datePicker_tgKhoiHanh.setValue(LocalDate.now());
    ...
    protected void clear() {
        ...
        tbl_lichTrinh.setItems(FXCollections.observableArrayList(lichTrinh_DAO.traCuuDSLichTrinhSauNgayHienTai()));
    }
    ...
    protected void add() {
        ...
        if (soHieuTau == null || gaDi == null || gaDen == null || ngayKH == null || trangThai == null) {
            Alert alert = new Alert(Alert.AlertType.INFORMATION);
            alert.setTitle("Thông báo");
