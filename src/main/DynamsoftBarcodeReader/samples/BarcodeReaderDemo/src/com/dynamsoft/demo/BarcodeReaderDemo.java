...
public final class BarcodeReaderDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Set license
        BarcodeReader.initLicense("t0068NQAAAIBYLjk5d3cy6MQC8alaY31XEGPo3hQ/tMHpmzHmib+T+6nHDg5l5YYXk58C3Pv49/uyQVbe0pBowmmfziBDt4M=");
        ...
        while (true) {
            ...
            BarcodeReader br = BarcodeReader.getInstance();
            // Read barcode           
            try {
